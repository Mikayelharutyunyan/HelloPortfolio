...
function getAcceleration(obj) {
	...
	var newaccx = -(gravityConst * obj.pos.x)/(r*r);
	var newaccy = -(gravityConst * obj.pos.y)/(r*r);
	var newaccz = -(gravityConst * obj.pos.z)/(r*r);


	return{
		x : newaccx, y : newaccy, z : newaccz
	}
//------------------- END YOUR CODE	
}
